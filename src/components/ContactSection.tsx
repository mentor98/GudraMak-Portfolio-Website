      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <div
            ...
            className="group relative rounded-3xl bg-gradient-to-b from-[#181818] to-[#121212] border border-[#2a2a2a] p-6 hover:border-[#fa5a02]/60 transition-all duration-300 shadow-xl flex flex-col justify-between"
          >
            ...
            <a
              ...
              className="w-full py-3 px-4 rounded-xl bg-[#222] hover:bg-[#fa5a02] text-gray-200 hover:text-white font-semibold text-xs text-center transition-all flex items-center justify-center gap-2 border border-[#333] hover:border-[#fa5a02]"
            >
          ...
          <div
            ...
            className="group relative rounded-3xl bg-gradient-to-b from-[#181818] to-[#121212] border border-[#2a2a2a] p-6 hover:border-emerald-500/60 transition-all duration-300 shadow-xl flex flex-col justify-between"
          >
            ...
            <a
              ...
              className="w-full py-3 px-4 rounded-xl bg-[#222] hover:bg-emerald-600 text-gray-200 hover:text-white font-semibold text-xs text-center transition-all flex items-center justify-center gap-2 border border-[#333] hover:border-emerald-500"
            >
        ...
        {/* Horizontal Connectivity & Social Bar */}
        <div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            ...
            <div className="flex items-center gap-2.5 sm:ml-4">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="w-10 h-10 rounded-xl bg-[#242424] hover:bg-[#1f2328] hover:text-white flex items-center justify-center text-gray-300 text-base hover:-translate-y-1 transition-all border border-[#333]"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-xl bg-[#242424] hover:bg-[#0077b5] hover:text-white flex items-center justify-center text-gray-300 text-base hover:-translate-y-1 transition-all border border-[#333]"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-10 h-10 rounded-xl bg-[#242424] hover:bg-[#c4302b] hover:text-white flex items-center justify-center text-gray-300 text-base hover:-translate-y-1 transition-all border border-[#333]"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 rounded-xl bg-[#242424] hover:bg-[#1877f2] hover:text-white flex items-center justify-center text-gray-300 text-base hover:-translate-y-1 transition-all border border-[#333]"
              >
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold text-xs sm:text-sm shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/30 hover:-translate-y-0.5 transition-all flex items-center gap-2"
            >
              <i className="fab fa-whatsapp text-sm" />
            ...
            <a
              id="cta-email-quick"
              href={`mailto:${PROFILE.email}`}
              className="px-5 py-3 rounded-xl bg-gradient-to-r from-[#fa5a02] to-[#c73e00] text-white font-bold text-xs sm:text-sm shadow-lg shadow-[#fa5a02]/30 hover:shadow-xl hover:shadow-[#fa5a02]/50 hover:-translate-y-0.5 transition-all flex items-center gap-2"
            >
              <i className="fas fa-envelope text-xs" />
