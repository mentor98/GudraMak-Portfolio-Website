        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <FadeUp delay={120} className="h-full">
            <div className="card-hover-effect p-7 rounded-2xl bg-[#161616] border border-[#262626] relative group shadow-lg h-full flex flex-col justify-between">
              ...
              <ul className="space-y-2 text-sm text-gray-400 pt-2 border-t border-[#242424]">
          ...
          <div className="p-7 sm:p-9 rounded-3xl bg-[#141414] border border-[#282828] shadow-xl mb-12">
            <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
              ...
              <button
                ...
                onClick={onOpenCV}
                className="btn-interactive inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#fa5a02]/15 hover:bg-[#fa5a02] text-[#fa5a02] hover:text-white border border-[#fa5a02]/30 text-xs sm:text-sm font-semibold cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {SKILL_CATEGORIES.map((category, catIdx) => (
                <div
                  key={catIdx}
                  className="card-hover-effect p-5 rounded-2xl bg-[#1a1a1a] border border-[#2b2b2b] flex flex-col justify-between"
                >
                  <div>
          ...
          <div className="card-hover-effect p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-[#fa5a02]/20 via-[#c73e00]/15 to-[#fa5a02]/10 border border-[#fa5a02]/30 text-center flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <button
                ...
                className="btn-interactive px-6 py-3 rounded-full bg-[#fa5a02] hover:bg-[#ff6b1a] text-white font-bold text-sm shadow-lg shadow-[#fa5a02]/30 cursor-pointer"
              >
                Me contacter
              </button>
              <button
                onClick={() => onNavigate('projects')}
                className="btn-interactive px-6 py-3 rounded-full bg-[#1b1b1b] hover:bg-[#252525] text-gray-200 border border-[#333] font-semibold text-sm cursor-pointer"
              >
                Voir mes projets
              </button>
            </div>
