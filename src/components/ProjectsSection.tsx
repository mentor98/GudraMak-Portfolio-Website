            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`btn-interactive px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 cursor-pointer ${
                    isActive
                ...
                >
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="btn-interactive w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#202020] hover:bg-[#fa5a02] text-gray-200 hover:text-white text-sm font-semibold cursor-pointer shadow-sm"
                    >
        ...
        <FadeUp delay={200} variant="zoom-up">
          <div className="mt-16 text-center">
            ...
            <button
              ...
              className="btn-interactive inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#fa5a02] hover:bg-[#ff6b1a] text-white font-bold text-sm shadow-lg shadow-[#fa5a02]/30 transition-all cursor-pointer"
            >
